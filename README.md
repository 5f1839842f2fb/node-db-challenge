...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    A relational database is a category of database where tables are related to eachother through specific fields. SQL is the language we use to communicate with those databases
- [ ] Why do tables need a `primary key`?
    Primary keys are the field that are the main identifier of an entry in a table and are what is referenced from other tables.
